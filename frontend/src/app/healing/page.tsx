...
const JOURNEYS = [
  ...
  { icon: "🤝", title: "소중한 이와의 매듭을 풀고 싶은 분", desc: "가족이나 이웃 안에서 사랑을 실천하고 싶지만, 마음의 벽에 부딪혀 갈등과 외로움을 겪고 계실 때" },
  { icon: "🌱", title: "나 자신을 온전히 사랑하고 싶은 분", desc: "스스로를 자책하거나 미워하기보다, 주님께서 창조하신 본연의 귀한 '나'를 발견하고 자비로운 마음을 회복하고 싶을 때" },
  { icon: "🌸", title: "비신자이지만 평화를 찾고 싶은 분", desc: "가톨릭의 정적이고 따뜻한 분위기 속에서 치유받고 싶을 때" },
];
